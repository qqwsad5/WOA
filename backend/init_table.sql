...
CREATE TABLE weibo (
  weibo_id text primary key, -- identifier for original weibo, provided by "user_id/mid"
...
CREATE TABLE transmitted (
  trans_id text primary key, -- identifier for transmission, provided by "user_id/mid"
